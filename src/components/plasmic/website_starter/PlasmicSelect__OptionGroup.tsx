...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: CRomRYvjTiHr/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: 0dhDI4-ZqEDz/render
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option___4PlWg)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__lVjy9)}
              />
            </React.Fragment>
          ),
          value: args.children
