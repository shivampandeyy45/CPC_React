...
import sty from "./PlasmicButton2.module.css"; // plasmic-import: nXa0PEyntLLk/css

import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: MCTDKNodVWrb/icon
import Icon38Icon from "./icons/PlasmicIcon__Icon38"; // plasmic-import: oc_etAnxl707/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__rZOu7)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <Icon38Icon
                className={classNames(projectcss.all, sty.svg___9Hd9)}
                role={"img"}
              />
            ),
